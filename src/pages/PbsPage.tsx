...
const features = [
  {
    title: 'Γενική Λογιστική',
    desc: 'Πλήρης διπλογραφική λογιστική, ισολογισμός, αποτελέσματα χρήσης, φορολογικές δηλώσεις και ηλεκτρονικά βιβλία ΑΑΔΕ.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Παραγγελίες, τιμολόγηση, πίνακες τιμών, εκπτώσεις και ολοκληρωμένη διαχείριση αγορών και πωλήσεων.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
  ...
  },
  {
    ...
    desc: 'Διαχείριση αποθεμάτων σε πολλαπλές αποθήκες, serial numbers, παρτίδες και παρακολούθηση κινήσεων.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
  ...
  {
    title: 'Μισθοδοσία & HR',
    desc: 'Μισθοδοτικές καταστάσεις, ΑΠΔ, αναλυτικές εργασίας ΕΦΚΑ, Εργάνη και διαχείριση ανθρωπίνου δυναμικού.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
  ...
  {
    title: 'Παγιουχία',
    desc: 'Διαχείριση παγίων περιουσιακών στοιχείων, αποσβέσεις φορολογικές και λογιστικές, και ιστορικό κινήσεων.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
  ...
  },
  {
    ...
    desc: 'Αυτόματη διαβίβαση παραστατικών στην ΑΑΔΕ, σύνδεση με παρόχους ΥΠΑΗΕΣ και πλήρης φορολογική συμμόρφωση.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
...
const services = [
  ...
  'Αναβαθμίσεις & ενημερώσεις έκδοσης',
  ...
  return (
    <div className="pt-20 bg-white min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="py-12 lg:py-16">
              <div className="mb-8">
                <img src={pbsoneLogo} alt="PBS ONE" className="h-10 sm:h-14 object-contain" />
              </div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-sky-400 mb-2">
                Λύσεις Μηχανογράφησης · Prosvasis
              </p>
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-white text-slate-900 font-bold px-5 py-2.5 rounded-xl shadow-lg hover:bg-slate-50 transition-all text-sm"
              >
            ...
            <div className="hidden lg:flex justify-end items-center py-8">
              <div className="w-72 bg-white/10 border border-white/15 rounded-2xl p-6">
                <p className="text-[10px] font-black uppercase tracking-widest text-sky-400 mb-5">
                  Βασικά Modules
                </p>
                <div className="space-y-3">
                  {features.map((f) => (
                    <div key={f.title} className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-slate-700/60 text-sky-300 flex items-center justify-center shrink-0">
                        {f.icon}
                      </div>
                ...
                <div className="mt-5 pt-4 border-t border-white/10 space-y-1.5">
                  {['✓ myDATA Ready', '✓ Εξουσ. Συνεργάτης', '✓ ΑΑΔΕ Συμμόρφωση'].map((b) => (
                    <p key={b} className="text-sky-300/60 text-xs">{b}</p>
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="mb-10">
            <span className="text-sky-600 font-bold text-xs uppercase tracking-[0.2em]">Δυνατότητες</span>
            ...
            <div className="divide-y divide-slate-200">
              {services.map((s, i) => (
                <div key={s} className="flex items-start gap-4 py-4 first:pt-0 last:pb-0">
                  <span className="text-[11px] font-black text-sky-400/60 w-6 shrink-0 mt-0.5">
                    {String(i + 1).padStart(2, '0')}
                  </span>
      ...
      <section className="py-14 bg-slate-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            ...
            <Link
              to="/contact"
              className="shrink-0 inline-flex items-center gap-2 bg-white text-slate-900 font-bold px-6 py-3 rounded-xl shadow-lg hover:bg-slate-50 transition-all text-sm"
            >
