...
export default function LexmarkPage() {
  ...
  return (
    <div className="pt-20 bg-white min-h-screen">
      ...
      {/* ── Hero ── */}
      <section className="bg-emerald-950 px-4 pt-10 pb-14">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-4 text-sm text-emerald-100/70 leading-relaxed">
              <p>
                Οι εκτυπωτές Pantum συνδυάζουν υψηλή απόδοση, αξιοπιστία και χαμηλό κόστος
                εκτύπωσης, καθιστώντας τους ιδανική επιλογή για επιχειρήσεις κάθε μεγέθους.
                Από τον απλό μονόχρωμο εκτυπωτή γραφείου έως τον πολυλειτουργικό με ADF, η
                σειρά Pantum καλύπτει όλες τις σύγχρονες ανάγκες εκτύπωσης εγγράφων.
              </p>
              <p>
                Με τεχνολογία λέιζερ υψηλής ακρίβειας, ταχύτητα έως 22 σελίδες ανά λεπτό και
                ανάλυση 1200 dpi, κάθε έγγραφο εκτυπώνεται με εξαιρετική διαύγεια και ευκρίνεια.
                Η ασύρματη σύνδεση WiFi επιτρέπει εκτύπωση από οποιαδήποτε συσκευή, ενώ η
                υποστήριξη δικτύου (Ethernet) στα πολυλειτουργικά μοντέλα εξυπηρετεί ολόκληρο
                το γραφείο ταυτόχρονα.
              </p>
              <p className="font-semibold text-emerald-100">
                Επιλέξτε Pantum και απολαύστε επαγγελματική εκτύπωση με το χαμηλότερο δυνατό
                κόστος ανά σελίδα.
              </p>
            </div>
          </div>
      ...
      <div className={`fixed bottom-6 right-6 z-40 w-56 bg-white rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 ${
        ...
        <div className="bg-gradient-to-r from-emerald-700 to-emerald-500 px-4 py-3">
          <p className="text-[9px] font-black uppercase tracking-widest text-emerald-100">Εκτυπωτές Pantum</p>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-4">
        <div className="flex items-center gap-3">
          <span className="text-xs font-black uppercase tracking-[0.2em] text-emerald-600">Τα Προϊόντα μας</span>
      ...
      <div ref={productsRef} className="max-w-5xl mx-auto px-4 sm:px-6 pb-10">
        {printerProducts.map((p) => (
          <div key={p.id} id={p.id} className="scroll-mt-24">
            <ProductRow product={p} accentText="text-emerald-600" />
          </div>
        ))}
      </div>
